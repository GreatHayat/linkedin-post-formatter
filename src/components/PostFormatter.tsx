            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200">
              ...
              <div className="border-b border-gray-200 p-4">
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <button
                    ...
                    className="p-2 hover:bg-gray-100 rounded-lg transition-colors duration-200 disabled:opacity-40 disabled:cursor-not-allowed"
                    title="Undo (Ctrl+Z)"
                  >
              ...
              <div className="relative">
                <textarea
                  ...
                  className="w-full h-80 p-6 resize-none focus:outline-none text-gray-900 text-sm leading-relaxed"
                />
              </div>
            </div>
              ...
              <div className="p-4">
                ...
                <div className="flex items-start space-x-3 mb-4">
                  <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-500 rounded-full flex items-center justify-center">
                    <span className="text-white font-semibold text-lg">YN</span>
                  </div>
                  <div className="flex-1">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-blue-600 text-sm">3rd+</span>
                    </div>
